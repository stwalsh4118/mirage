...
- [ ] ProvisionServices verifies environment ownership
- [ ] ProvisionServices sets UserID from auth context
- [ ] GetService filters by user
- [ ] DeleteRailwayService verifies ownership
- [ ] Ownership verification helper created
...
- `api/internal/controller/services_test.go` - Update tests
