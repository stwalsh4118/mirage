...
- `web/src/app/sign-in/[[...sign-in]]/page.tsx` - Create sign-in page
- `web/src/app/sign-up/[[...sign-up]]/page.tsx` - Create sign-up page
- `web/src/lib/auth.ts` - Create auth utilities (optional)
