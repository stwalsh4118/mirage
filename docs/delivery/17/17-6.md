...
- [ ] VaultStatus type defined
- [ ] Circuit breaker state machine implemented
- [ ] Circuit breaker integrated into Client
- [ ] Circuit state accessible via GetCircuitState method
- [ ] Health check endpoint implemented
- [ ] Background health checker implemented
...
- `api/internal/vault/circuit_breaker.go` (new)
