...
| :------ | :--------------------------------------- | :------- | :--------------------------------- |
| 17-1 | [Research and document HashiCorp Vault Go API](./17-1.md) | Proposed | Research Vault Go SDK API, KV v2 secrets engine, authentication methods, and create implementation guide |
...
| 17-4 | [Install Vault Go client and implement initialization](./17-4.md) | Proposed | Install vault/api package, create vault package with client initialization and configuration |
