# Tasks for PBI 9: Railway Project Browsing & Details
...
| :------ | :--------------------------------------- | :------- | :--------------------------------- |
| 9-1 | [Add Projects grid to dashboard](./9-1.md) | Review | Show Railway projects with counts and link to details |
